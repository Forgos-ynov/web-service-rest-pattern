 ...
 * @param {{apis: string[], definition: {servers: [{description: string, url: string}], openapi: string, info: {description: string, title: string, version: string}}}} options - Configuration options
